...
const stylesheetPattern = /\s*<link id="main-styles"[^>]*>\s*<noscript><link rel="stylesheet" href="\.\/css\/main\.css(?:\?v=\w+)?"><\/noscript>/;
const recoveryPattern = /\s*<script id="style-recovery">[\s\S]*?<\/script>/;
const externalScriptPattern = /\s*<script src="\.\/js\/(?:calculator-config|calculator|main)\.js(?:\?v=\w+)?" defer><\/script>/g;
